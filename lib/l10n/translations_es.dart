const Map<String, String> esStrings = {
  ...
  'analysisPreviewTitle': 'Los gráficos e ideas te están esperando',
  'analysisPreviewTeaser':
      'Previsualiza tendencias de ingresos y gráficos por programa.',
  'monthlyAnalysisTitle': 'Análisis Mensual',
  'monthlyAnalysisNoData': 'No hay datos analíticos para este mes.',
  'monthlySelectedMonth': 'Mes Seleccionado',
  'selectMonthYear': 'Elegir mes y ano',
  'monthlyOverviewTitle': 'Resumen Mensual',
  'monthlyPaidTotal': 'Total Cobrado Mensual',
  'monthlyExpectedTotal': 'Total Esperado Mensual',
  'monthlyCollectionRate': 'Tasa de Cobro',
  'monthlyOutstandingAmount': 'Monto Pendiente',
  'monthlyInsightsTitle': 'Ideas Mensuales',
  'monthlyChartsTitle': 'Gráficos',
  'monthlyRevenueTrendTitle': 'Tendencia de Cobro de los Últimos 6 Meses',
  'monthlyProgramTypeChartTitle': 'Cancelaciones por Tipo de Programa',
  'monthlyChartsEmpty': 'No hay datos para mostrar en este gráfico.',
  'monthlyTrendPaidLegend': 'Cobrado',
  'monthlyTrendExpectedLegend': 'Esperado',
  'monthlyMostCancelledLabel': 'Programa con Más Cancelaciones',
  'monthlyHighestCancellationRateLabel': 'Mayor Tasa de Cancelación',
  'monthlyCollectionStatusLabel': 'Estado del Cobro',
  'monthlyStatusStrong': 'En Objetivo',
  'monthlyStatusWatch': 'Seguir de Cerca',
  'monthlyStatusAttention': 'Requiere Acción',
  'monthlyNonHolidayCancelCount': 'Cancelaciones',
  'monthlyTopCancellationsTitle': 'Programas con Más Cancelaciones',
  'monthlyTopCancellationsEmpty': 'No hay cancelaciones este mes.',
  'monthlyTopCancellationMetrics':
      'Canceladas: {count} | Participación: {share}% | Tasa mensual: {rate}%',
  ...
  'premiumDesc':
      'Hazte Premium para atletas, periodos, medidas corporales, plan semanal y pagos ilimitados — sin anuncios.',
