const Map<String, String> enStrings = {
  ...
  'analysisPreviewTitle': 'Charts and insights are waiting here',
  'analysisPreviewTeaser': 'Preview revenue trends and program mix charts.',
  'monthlyAnalysisTitle': 'Monthly Analysis',
  'monthlyAnalysisNoData': 'No analytics data for this month.',
  'monthlySelectedMonth': 'Selected Month',
  'selectMonthYear': 'Choose month-year',
  'monthlyOverviewTitle': 'Monthly Overview',
  'monthlyPaidTotal': 'Monthly Collected Total',
  'monthlyExpectedTotal': 'Monthly Expected Total',
  'monthlyCollectionRate': 'Collection Rate',
  'monthlyOutstandingAmount': 'Outstanding Amount',
  'monthlyInsightsTitle': 'Monthly Insights',
  'monthlyChartsTitle': 'Charts',
  'monthlyRevenueTrendTitle': 'Last 6 Months Revenue Trend',
  'monthlyProgramTypeChartTitle': 'Cancellations by Program Type',
  'monthlyChartsEmpty': 'No data available for this chart.',
  'monthlyTrendPaidLegend': 'Collected',
  'monthlyTrendExpectedLegend': 'Expected',
  'monthlyMostCancelledLabel': 'Most Cancelled Program',
  'monthlyHighestCancellationRateLabel': 'Highest Cancellation Rate',
  'monthlyCollectionStatusLabel': 'Collection Status',
  'monthlyStatusStrong': 'On Track',
  'monthlyStatusWatch': 'Watch Closely',
  'monthlyStatusAttention': 'Action Needed',
  'monthlyNonHolidayCancelCount': 'Cancellations',
  'monthlyTopCancellationsTitle': 'Top Programs with Cancellations',
  'monthlyTopCancellationsEmpty': 'No cancellations this month.',
  'monthlyTopCancellationMetrics':
      'Cancelled: {count} | Share: {share}% | Monthly rate: {rate}%',
  ...
  'premiumDesc':
      'Go Premium for unlimited athletes, periods, body measurements, weekly plan and payment tracking — all ad-free.',
